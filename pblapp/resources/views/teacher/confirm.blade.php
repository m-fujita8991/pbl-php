...
@section('content')
    ...
    <p style="font-size:25px;">　　　　　　　名前 <input type="text" style="width:250px; height:30px; font-size:25px;" name="name" value="" disabled></p>
    <p style="font-size:25px;">　　　　　フリガナ <input type="text" style="width:250px; height:30px; font-size:25px;" name="hurigana" value="" disabled></p>
    <p style="font-size:25px;">　　　　　参加日付 <select name="date" style="width:250px; height:30px; font-size:25px;"></select></p>
    <p style="font-size:25px;">　　　　　参加学科 <input type="text" style="width:250px; height:30px; font-size:25px;" name="department" value="" disabled></p>
