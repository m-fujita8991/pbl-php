...
@csrf
    ...
    <input type="radio" style="width:40px; height:40px;" name="where" value="0" required="required" >岡山県内<br>
    <input type="radio" style="width:40px; height:40px;" name="where" value="1" required="required" >岡山県外
