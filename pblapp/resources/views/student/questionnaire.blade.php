...
@section('title','アンケート')
@section('content')
<form action = "participant2" method = "get">
@csrf
    <p style="font-size:70px; text-align:center; color:#000000;">Q.どこから来ましたか？<br>
    <input type="radio" style="width:40px; height:40px;" name="student" value="1" required="required" >岡山県内<br>
    <input type="radio" style="width:40px; height:40px;" name="student" value="0" required="required" >岡山県外
