...
@csrf
    ...
    <input type="radio" style="width:40px; height:40px;" name="student" value="初回" required="required" >初回<br>
    <input type="radio" style="width:40px; height:40px;" name="student" value="参加者No" required="required" >参加者No
