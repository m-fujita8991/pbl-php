...
<form>
    ...
    <input type="radio" style="width:40px; height:40px;" name="student" value="岡山県内" required="required">岡山県内からお越しの方<br>
       <select name="tiikimei" style=" font-size:30px; width:300px; height:50px;">
          <option value="岡山市" >岡山市</option>
          <option value="選択肢2">選択肢2</option>
          <option value="選択肢3">選択肢3</option>
       </select><br><br>
    <input type="radio" style="width:40px; height:40px;" name="student" value="参加者No" required="required">岡山県外からお越しの方<br>
